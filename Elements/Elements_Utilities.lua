...
Elements.Utilities.AddShadow = function(parent, shadowPoint, shadowOffsetY)
  ...
  local shadow =
  CreateFrame("Frame", parent:GetName() .. "SHADOW_BORDER", parent, BackdropTemplateMixin and "BackdropTemplate")
...
Elements.Utilities.AddHighlightAndShadow = function(parent, invert, highlightColour)
  ...
  -- Highlight
  local highlight =
  CreateFrame("Frame", parent:GetName() .. "INNER_BORDER", parent, BackdropTemplateMixin and "BackdropTemplate")
