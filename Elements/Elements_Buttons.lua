Elements.Buttons.CreateButton = function(
  ...
  local button = CreateFrame("Button", name, frame, BackdropTemplateMixin and "BackdropTemplate")
  ...
  Elements.Utilities.AddHighlightAndShadow(button)
  ...
  local buttonLabel = Elements.Text.CreateFreeText(fontPath, name .. "_TEXT", button, text, textSize)
  buttonLabel:SetPoint("CENTER", button)
